...
- Create Angular project with ng: `ng new todolistangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`todolistangular.client.esproj`).
